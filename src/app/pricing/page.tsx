...
export const metadata: Metadata = {
  title: "Pricing — Tahsili Premium",
  description: "Unlock unlimited Tahsili practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=tahsili&cadence=annual`;
